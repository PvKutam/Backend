    ...
    const getAllUser= asyncHanlder(async(req,res)=>{
        ...
        .json(200,req.user,"Fetched user data")
    })
    ...
    const updateAccoutDetails = asyncHanlder(async(req,res)=>{
        ...
        return res.status(200)
        .json(
            new ApiResponce(200,user,"Account details successfully")
        )
    })
...
const updateUserCoverImage = asyncHanlder(async(req, res) => {
    ...
    export { registerhandler,Loginhanlder,logout,
        refreshAccessToken,changeCurrentPassword,getAllUser,
        updateAccoutDetails,updateUserAvatar,updateUserCoverImage };
